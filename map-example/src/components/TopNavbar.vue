    ...
    <div class="navbar-container">
      <div class="navbar-left">
        ...
        <nav class="custom-nav">
          <ul class="nav-list">
            ...
            <li
              class="nav-item"
              :class="{ active: activeMenu === 'leaflet' }"
            ...
            <li
              class="nav-item"
              :class="{ active: activeMenu === 'openlayers' }"
            ...
            <li
              class="nav-item"
              :class="{ active: activeMenu === 'cesium' }"
      ...
      <div class="navbar-right">
        <a
          ...
          href="https://github.com/YGYong/map-ecology"
          target="_blank"
          title="GitHub"
        >
          <svg
